...
class StudentLogsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_student_logs) // Set the new layout
    ...
    private fun logout() {
        ...
        // For example, clear shared preferences or any session variables
