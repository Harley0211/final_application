...
class FacultyStaffLogsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_faculty_staff_logs) // Set the new layout
    ...
    private fun navigateToPage(page: String) {
        when (page) {
            ...
            "FacultyLogs" -> {
                // Stay in FacultyStaffLogsActivity
            }
            "VisitorLogs" -> {
